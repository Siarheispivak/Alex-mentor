...
function editCardPets(card, number) {
...
createCardTemplate = (petNumber, cardNumber) => {
    ...
    petsInner.classList.add(sliderPets[petNumber].name);
...
function generateNewCarusel() {
    let changedItem = ITEM_ACTIVE;

    let activeCards = document.querySelectorAll('#item-active .card-test .pets__card-inner .pets__inner');
